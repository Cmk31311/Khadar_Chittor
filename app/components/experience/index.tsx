  ...
  return (
    <group position={[0, -41.5, 12]} rotation={[-Math.PI / 2, 0 ,-Math.PI / 2]}>
      <group rotation={[0, 0, Math.PI / 2]}>
        ...
        <group position={[0, -1, 0]} ref={groupRef} scale={isMobile ? [1, 1, 1] : [0.55, 0.55, 0.55]}>
          <GridTile title='WORK AND EDUCATION'
            id="work"
            color='#b9c6d6'
            textAlign='left'
            position={new THREE.Vector3(isMobile ? -1 : -7.0, isMobile ? 6.75 : 0, isMobile ? 0.4 : 0)}>
            <group scale={isMobile ? [1, 1, 1] : [1/0.55, 1/0.55, 1/0.55]}>
              <Work/>
            </group>
          </GridTile>
          <GridTile title='PROJECTS'
            ...
            color='#bdd1e3'
            textAlign='right'
            position={new THREE.Vector3(isMobile ? 1 : -2.3, isMobile ? 2.25 : 0, 0)}>
            <group scale={isMobile ? [1, 1, 1] : [1/0.55, 1/0.55, 1/0.55]}>
              <Projects/>
            </group>
          </GridTile>
          ...
          <GridTile title='ACHIEVEMENTS'
            ...
            color='#AEC6CF'
            textAlign='right'
            position={new THREE.Vector3(isMobile ? 1 : 7.0, isMobile ? -6.75 : 0, 0)}>
            <group scale={isMobile ? [1, 1, 1] : [1/0.55, 1/0.55, 1/0.55]}>
              <Achievements/>
            </group>
          </GridTile>
